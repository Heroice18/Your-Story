...
model = tf.keras.models.load_model('../Phython/fantasy_model.h5')

# Read the data
# Read, then decode for py2 compat.
text = open('../Phython/fantasy.txt', 'rb').read().decode(encoding='utf-8')
# length of text is the number of characters in it
...
def build_model(vocab_size, embedding_dim, rnn_units, batch_size):
    model = tf.keras.Sequential([
        ...
        tf.keras.layers.Dense(vocab_size/2, activation="selu"),
        tf.keras.layers.Dense(vocab_size/1.5, activation="selu"),
        tf.keras.layers.Dense(vocab_size/.75, activation="selu"),
        tf.keras.layers.Dense(vocab_size/.25, activation="selu"),
        tf.keras.layers.Dense(vocab_size, activation="selu")
    ])
    return model
